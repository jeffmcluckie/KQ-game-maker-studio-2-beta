...
//Idle
playerSpr[playerState.idle][0] = spr_player_idle;
playerSpr[playerState.idle][1] = spr_player_idle;
playerSpr[playerState.idle][2] = spr_player_idle;
playerSpr[playerState.idle][3] = spr_player_idle;
...
//Idle while carrying
playerSpr[playerState.carryIdle][0] = spr_player_carryIdle;
playerSpr[playerState.carryIdle][1] = spr_player_carryIdle;
playerSpr[playerState.carryIdle][2] = spr_player_carryIdle;
playerSpr[playerState.carryIdle][3] = spr_player_carryIdle;
